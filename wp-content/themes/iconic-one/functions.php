...
function themonic_content_nav( $html_id ) {
	...
	if ( $wp_query->max_num_pages > 1 ) : ?>
		<nav id="<?php echo $html_id; ?>" class="navigation" role="navigation">
			...
			<div class="nav-previous alignleft"><?php previous_posts_link( __( '&laquo; Previous page', 'themonic' ) ); ?></div>
			<div class="nav-next alignright"><?php next_posts_link( __( 'Next page &raquo;', 'themonic' ) ); ?></div>
...
function my_admin_theme_style() {
    wp_enqueue_style('my-admin-style', get_template_directory_uri() . '/css/editor-style.css');
}
